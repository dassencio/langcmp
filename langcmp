...
def main(nsubproc, min_wlen, max_dist, verbose, in_file, out_file, stats_file, plot_hist, hist_file):
...
if __name__ == "__main__":
	...
	parser.add_argument('-s', '--statistics-file', type=argparse.FileType('w'), default=sys.stdout, help='statistics file (default: stdout)')
	parser.add_argument('-g', '--histogram-file', type=argparse.FileType('w'), default=sys.stdout, help='histogram data file (default: stdout)')
	...
	stats_file = namespace.statistics_file
	hist_file  = namespace.histogram_file
	plot_hist  = namespace.plot_histogram

	main(nsubproc, min_wlen, max_dist, verbose, in_file, out_file, stats_file, plot_hist, hist_file)
